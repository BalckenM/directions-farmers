...
leaveRouter.post("/leave-requests", validate(createLeaveRequestSchema), payrollController.createLeaveRequest);
leaveRouter.put("/leave-requests/:id/approve", payrollController.approveLeave);
leaveRouter.put("/leave-requests/:id/reject", payrollController.rejectLeave);
...
leaveRouter.post("/piecework-logs", validate(createPieceworkLogSchema), payrollController.createPiecework);
