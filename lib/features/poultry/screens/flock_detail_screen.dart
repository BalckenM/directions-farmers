  ...
  Widget build(BuildContext context) {
    ...
    return flockAsync.when(
      ...
      data: (flock) {
        ...
        return _FlockDetailView(
            flockId: widget.flockId, flock: flock, tabs: _tabs);
      },
    );
  }
}
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return FarmScaffold(
      ...
      appBar: FarmAppBar(
        ...
        subtitle:
            '${flock.productionType} · Day ${flock.dayOfAge}',
        actions: [
          IconButton(
      ...
      body: Column(
        children: [
          ...
          Consumer(
            builder: (ctx, ref, _) {
              final isSpiking =
                  ref.watch(mortalitySpikeProvider(flockId));
    ...
    return Column(
      ...
      children: [
        ...
        Expanded(
          ...
          GridView.count(
            ...
            children: [
              ...
              _KpiCard(
                ...
                alert: flock.livabilityPct != null && flock.livabilityPct! < 95,
              ),
              _KpiCard(
                label: 'Mortality %',
          ...
          _InfoRow(
              label: 'Current count', value: '${flock.currentCount}'),
          _InfoRow(
          ...
          if (flock.isLayer && flock.layerSpecific != null) ...[
            ...
            dailyAsync.whenOrNull(data: (records) {
              ...
              for (var i = 0; i < last30.length; i++) {
                ...
                if (v != null) hdpSpots.add(FlSpot(i.toDouble(), v));
              }
          ...
          if (flock.isBroiler && flock.broilerSpecific != null) ...[
            ...
            _InfoRow(
                ...
                value: flock.broilerSpecific!.targetFcr42d != null
                    ? flock.broilerSpecific!.targetFcr42d!.toStringAsFixed(2)
                    : 'â€”'),
            ...
            dailyAsync.whenOrNull(data: (records) {
              ...
              for (final r in records) {
                if (r.dayOfAge != null && r.avgBodyWeightG != null) {
                  actualSpots.add(
                      FlSpot(r.dayOfAge!.toDouble(), r.avgBodyWeightG!.toDouble()));
                }
              }
          ...
          if (flock.status == 'harvested' || flock.status == 'depleted') ...[
            const SizedBox(height: AppSpacing.md),
                ...
                return Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        _InfoRow(
                            label: 'Harvest Date', value: hr.harvestDate),
                        _InfoRow(
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        onTap: () =>
                            context.push('/livestock/poultry/${flock.id}/biosecurity'),
                      ),
                      if (flock.isBroiler || flock.productionType == 'turkey') ...[
                        ...
                        ListTile(
                          ...
                          trailing: const Icon(Icons.chevron_right),
                          onTap: () =>
                              context.push('/livestock/poultry/${flock.id}/litter'),
                        ),
                      ],
                      if (flock.isLayer) ...[
                        const Divider(height: 1),
                        ListTile(
                          ...
                          trailing: const Icon(Icons.chevron_right),
                          onTap: () =>
                              context.push('/livestock/poultry/${flock.id}/molt'),
                        ),
                      ],
                      if (flock.productionType == 'breeder') ...[
                        ...
                        ListTile(
                          ...
                          trailing: const Icon(Icons.chevron_right),
                          onTap: () => context
                              .push('/livestock/poultry/${flock.id}/breeder-records'),
                        ),
                      ],
                      if (flock.isLayer || flock.productionType == 'breeder') ...[
                        const Divider(height: 1),
                        ListTile(
                          ...
                          trailing: const Icon(Icons.chevron_right),
                          onTap: () => context
                              .push('/livestock/poultry/${flock.id}/egg-sales/new'),
                        ),
                      ],
                    ],
                  ),
...
class _DailyRecordsTab extends ConsumerWidget {
  const _DailyRecordsTab(
      {required this.flockId, required this.recordsAsync});
      ...
      children: [
        ...
        _TabActionBar(actions: [
          _TabAction(
            ...
            label: 'Add Record',
            onTap: () => context.push(AppRoutes.addPoultryDailyRecord(flockId)),
          ),
          _TabAction(
            ...
            data: (records) => records.isEmpty
                        ...
                        children: [
                          Icon(Icons.add_chart_outlined,
                              ...
                              color: AppColors.poultryColor
                                  .withAlpha(102)),
                          const SizedBox(height: AppSpacing.md),
                          const Text('No daily records yet',
                              style: TextStyle(
                ...
                : Builder(builder: (context) {
                    ...
                    final last2 = records.length >= 2
                        ...
                        : records;
                    final spikeDetected = last2.length == 2 &&
                        batchAvg > 0 &&
                        last2.every(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                TextButton(
                                  onPressed: () => context
                                      .push(AppRoutes.addDiseaseEvent(flockId)),
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return Dismissible(
                                ...
                                onDismissed: (_) {
                                  ref
                                      .read(dailyRecordDeleteProvider.notifier)
                                      .delete(rec.id);
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Day ${rec.dayOfAge} record deleted'),
...
class _DailyRecordTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final waterFeedAlert = record.waterConsumedLitres != null &&
          ...
          children: [
            Row(
              children: [
                ...
                if (waterFeedAlert)
                  const Tooltip(
                    message: 'Water-to-feed ratio exceeds 2.4 â€” check drinkers or respiratory health',
                    child: Icon(Icons.water_drop_outlined,
                        color: AppColors.warning, size: 18),
                  ),
                const SizedBox(width: AppSpacing.xs),
                _RecordStat(
                    label: 'Mort', value: '${record.mortalityCount ?? 0}'),
                _RecordStat(
                    label: 'Feed',
...
class _VaccinationTab extends ConsumerWidget {
  ...
  Future<void> _showMarkGivenSheet(
      BuildContext context, WidgetRef ref, VaccineItem item) async {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('${item.vaccine}  ·  Day ${item.targetDay}  ·  ${item.method}',
                    style: const TextStyle(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: AppSpacing.md),
                  const Text('No vaccination schedule',
                  ...
                  _TabActionBar(actions: [
                    _TabAction(
                      ...
                      onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Assign a vaccination schedule to this flock to log vaccines.'),
                          behavior: SnackBarBehavior.floating,
                        ),
                      ),
                    ),
                    _TabAction(
                      ...
                      onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Vaccination scheduling coming soon.'),
                          behavior: SnackBarBehavior.floating,
                        ),
                      ),
                    ),
          ...
          children: [
            ...
            _TabActionBar(actions: [
              _TabAction(
                ...
                onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Tap the âœ“ next to a pending vaccine to mark it as given.'),
                    behavior: SnackBarBehavior.floating,
                  ),
                ),
              ),
              _TabAction(
                ...
                onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Vaccination scheduling settings coming soon.'),
                    behavior: SnackBarBehavior.floating,
                  ),
                ),
              ),
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, i) => _VaccineItemTile(
                  ...
                  onMarkGiven: (!schedule.schedule[i].isCompleted)
                      ? () => _showMarkGivenSheet(
                          context, ref, schedule.schedule[i])
                      : null,
                ),
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return Text(text,
        style: Theme.of(context).textTheme.titleSmall?.copyWith(
            fontWeight: FontWeight.w700, color: AppColors.poultryColor));
  }
}
        ...
        medicationAsync.when(
          ...
          data: (logs) {
            if (logs.isEmpty) {
              return Padding(
                padding: const EdgeInsets.symmetric(vertical: AppSpacing.md),
                child: Text('No medications recorded.', style: tt.bodySmall),
              );
            }
            return Column(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text('Dose: ${log.dosage}', style: tt.bodySmall),
                          Text(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        liveAsync.whenOrNull(data: (reading) => Container(
          ...
          child: Row(
            children: [
              ...
              Text('Live · ${reading.sensorZone.toUpperCase()}',
                  style: tt.labelSmall?.copyWith(
                      color: AppColors.poultryColor,
                      fontWeight: FontWeight.bold)),
              const Spacer(),
              if (reading.tempC != null)
                _IoTChip('${reading.tempC!.toStringAsFixed(1)}Â°C',
                    reading.tempAlert),
              if (reading.humidityPct != null)
                _IoTChip('${reading.humidityPct!.toStringAsFixed(0)}%RH',
                    reading.humidityAlert),
              if (reading.ammoniaPpm != null)
                _IoTChip('${reading.ammoniaPpm!.toStringAsFixed(0)}ppm',
        ...
        _TabActionBar(actions: [
          ...
          _TabAction(
            ...
            onTap: () => ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Environmental alert configuration coming soon.'),
                behavior: SnackBarBehavior.floating,
              ),
            ),
          ),
        ...
        Expanded(
          child: envAsync.when(
            ...
            data: (readings) {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        OutlinedButton.icon(
                          onPressed: () =>
                              _showManualReadingDialog(context),
              ...
              // Group by zone
              final zones =
                  readings.map((r) => r.sensorZone).toSet().toList()
                    ..sort();
              final latest = <String, EnvironmentReading>{};
              for (final z in zones) {
                final zoneReadings =
                    readings.where((r) => r.sensorZone == z);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _EnvRow(
                              ...
                              alert: r.tempAlert,
                              alertLabel:
                                  r.tempAlert ? 'âš  Out of range' : null,
                            ),
                            _EnvRow(
                              label: 'Humidity',
                              ...
                              alertLabel:
                                  r.humidityAlert ? 'âš  High/low' : null,
                            ),
                            _EnvRow(
                              label: 'Ammonia',
                              ...
                              alertLabel:
                                  r.ammoniaAlert ? 'âš  >20 ppm' : null,
                            ),
                            if (r.co2Ppm != null)
                              _EnvRow(
                                label: 'COâ‚‚',
                                value:
                                    '${r.co2Ppm!.toStringAsFixed(0)} ppm',
                              ),
                          ],
                        ),
                      ),
      ...
      items.add(Expanded(
        child: TextButton.icon(
          ...
          style: TextButton.styleFrom(
            foregroundColor:
                a.onTap != null ? AppColors.poultryColor : Colors.grey,
            padding: const EdgeInsets.symmetric(vertical: 10),
          ),
        ),
      ));
      if (i < actions.length - 1) {
        items.add(const VerticalDivider(
          width: 1,
          thickness: 0.5,
          indent: 10,
          endIndent: 10,
...
class _FlockActionMenu extends ConsumerWidget {
  ...
  Future<void> _confirmStatusChange(
    ...
    if (confirmed == true && context.mounted) {
      ref.read(flockStatusOverrideProvider.notifier).setStatus(
            flockId,
            statusKey,
          );
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    return PopupMenuButton<String>(
      ...
      onSelected: (v) {
        switch (v) {
          ...
          case 'depleted':
            _confirmStatusChange(context, ref, 'Depleted', 'depleted',
                requireDate: true);
          case 'sold':
            _confirmStatusChange(context, ref, 'Sold', 'sold',
                requireDate: true);
        }
      },
    );
...
class _WeightBenchmarkChart extends StatelessWidget {
  ...
  List<FlSpot> _benchmarkSpots() {
    final maxDay =
        actualSpots.map((s) => s.x).reduce((a, b) => a > b ? a : b);
            ...
            if (belowBenchmark) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(color: AppColors.warning.withAlpha(128)),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
