...
class HealthEvent {
  ...
  HealthEvent copyWith({
    ...
    dagScore: dagScore ?? this.dagScore,
    isNotifiable: isNotifiable ?? this.isNotifiable,
    notifiableDisease: notifiableDisease ?? this.notifiableDisease,
    daffReportRef: daffReportRef ?? this.daffReportRef,
  );
}
