    ...
    return unitAsync.when(
      ...
      data: (unit) {
        ...
        return DefaultTabController(
          length: 2,
          child: _UnitDetailView(unitId: widget.unitId, unit: unit),
        );
      },
    );
  }
...
class _UnitDetailView extends ConsumerWidget {
  const _UnitDetailView({required this.unitId, required this.unit});
      ...
      child: Column(
        ...
        children: [
          ...
          if (batch != null) ...[
            ...
            _InfoRow(label: 'Stocking count', value: '${batch.initialCount}'),
            _InfoRow(
              label: 'Stocking date',
            ...
            _InfoRow(label: 'FCR', value: batch.fcrToDate.toStringAsFixed(2)),
          ],
