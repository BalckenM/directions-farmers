...
class AddPieceworkLogScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddPieceworkLogScreen> createState() =>
      _AddPieceworkLogScreenState();
}
...
class _AddPieceworkLogScreenState extends ConsumerState<AddPieceworkLogScreen> {
  ...
  Future<void> _save() async {
    ...
    if (_employeeId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Select an employee'),
    ...
    if (result != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Failed to save piecework log'),
          backgroundColor: AppColors.error,
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    ...
    final shifts = ref.watch(
      shiftsProvider(ShiftFilter(weekStart: monday, employeeId: _employeeId)),
    );
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        'R ${_computedGross.toStringAsFixed(2)}',
                        style: const TextStyle(
                          fontSize: 18,
            ...
            _SectionCard(
              ...
              children: [
                TextFormField(
                  ...
                  maxLines: 3,
                  decoration: _inputDec('Notes', icon: Icons.notes),
                ),
              ],
            ),
