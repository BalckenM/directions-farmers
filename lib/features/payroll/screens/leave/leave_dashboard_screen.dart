...
import 'package:mobile_app/shared/widgets/kpi_row.dart';
...
class LeaveDashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final allLeave = ref.watch(
      leaveRequestsProvider(const LeaveRequestFilter()),
    );
    ...
    final approved = allLeave
        .where((r) => r.status == LeaveStatus.approved)
        .length;
    final rejected = allLeave
        ...
        child: Row(
          children: [
            ...
            AvatarWidget(
              ...
              initials: empName.isNotEmpty ? empName[0].toUpperCase() : '?',
              radius: 20,
