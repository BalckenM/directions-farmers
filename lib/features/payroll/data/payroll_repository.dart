...
class PayrollRepository {
  ...
  Future<PayrollEmployee> addEmployee(PayrollEmployee e) =>
      _source.addEmployee(e);
  Future<Map<String, dynamic>> bulkImportEmployees(
    List<PayrollEmployee> employees,
  ) => _source.bulkImportEmployees(employees);
  Future<PayrollEmployee> updateEmployee(PayrollEmployee e) =>
  ...
  Future<EmploymentContract> addContract(EmploymentContract c) =>
      _source.addContract(c);
  Future<EmploymentContract> updateContract(EmploymentContract c) =>
  ...
  Future<PayGroup> deactivatePayGroup(String id) =>
      _source.deactivatePayGroup(id);

  // -- Pay structures
  List<PayStructure> getPayStructures() => _source.getPayStructures();
  Future<PayStructure> addPayStructure(PayStructure s) =>
      _source.addPayStructure(s);
  Future<PayStructure> updatePayStructure(PayStructure s) =>
  ...
  Future<TaskAssignment> addTaskAssignment(TaskAssignment t) =>
      _source.addTaskAssignment(t);
  Future<TaskAssignment> updateTaskAssignment(TaskAssignment t) =>
      _source.updateTaskAssignment(t);
  Future<bool> deleteTaskAssignment(String id) =>
      _source.deleteTaskAssignment(id);
  ...
  Future<PieceworkLog> addPieceworkLog(PieceworkLog l) =>
      _source.addPieceworkLog(l);
  ...
  Future<DeductionRule> addDeductionRule(DeductionRule r) =>
      _source.addDeductionRule(r);
  Future<DeductionRule> updateDeductionRule(DeductionRule r) =>
  ...
  Future<LeaveRequest> addLeaveRequest(LeaveRequest r) =>
      _source.addLeaveRequest(r);
  ...
  Future<IncidentRecord> addIncident(IncidentRecord i) =>
      _source.addIncident(i);
  Future<IncidentRecord> updateIncident(IncidentRecord i) =>
      _source.updateIncident(i);
